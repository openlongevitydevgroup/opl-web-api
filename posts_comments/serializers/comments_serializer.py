...
class CommentSerializer(serializers.ModelSerializer):
    class Meta: 
        model = Comment 
        fields = ["comment_id", "submission_id", "parent", "full_text", "alias", "created_at", "is_active"]
...
class RecursiveCommentSerializer(CommentSerializer):
    ...
    class Meta:
        model = Comment
        fields = ["comment_id", "submission_id", "parent", "full_text","created_at", "alias", "is_active"]
...
class CommentsSerializer(CommentSerializer):
    ...
    class Meta(CommentSerializer.Meta):
        model = Comment
        fields = ["comment_id", "submission_id", "parent", "full_text", "children", "alias", "created_at", "is_active"]
